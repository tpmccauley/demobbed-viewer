class MgrDrawED { // Manager intended for drawing of Electronic detector (2D) events
  ...
  constructor() {
    ...
    this._canvMainHeight = 320; //MMM 320  // Fixed!
    ...
    //this._viewChangeControl = 0; // Needed for d3.js to control change of view in order to redraw detectors
  ...
  canvasesMain(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::canvasesMain()::Error: ip is wrong: ip = " + ip + "!!!");
      return;
    }
  ...
  canvasesEmb(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::canvasesEmb()::Error: ip is wrong: ip = " + ip + "!!!");
      return;
    }
  ...
  zoom(zz) {
    ...
    if (!Utils.checkNumber(zz)) {
      alert("MgrDrawED::zoom()::Error: zz is not a number!!!: zz = " + zz + "!!!");
      return;
    }

    if ( (zz < 1) || (zz > 100) ) {
      alert("MgrDrawED::zoom()::Error: zz is strange!!!: zz = " + zz + "!!!");
      return;
    }
  ...
  moveFactor(ip) {
    ...
    if (!Utils.checkIP(ip, 3)) {
      alert("MgrDrawED::moveFactor()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  zoomIsChanged(zc) {
    ...
    if (!Utils.checkNumber(zc)) {
      alert("MgrDrawED::zoomIsChanged()::Error: zc is not a number!!!: zc = " + zc + "!!!");
      return;
    }

    if ( (zc != 0) && (zc != 1) ) {
      alert("MgrDrawED::zoomIsChanged()::Error: zc is strange!!!: zc = " + zc + "!!!");
      return;
    }
  ...
  viewIsChanged(vc) {
    ...
    if (!Utils.checkNumber(vc)) {
      alert("MgrDrawED::viewIsChanged()::Error: vc is not a number!!!: vc = " + vc + "!!!");
      return;
    }

    if ( (vc != 0) && (vc != 1) ) {
      alert("MgrDrawED::viewIsChanged()::Error: vc is strange!!!: vc = " + vc + "!!!");
      return;
    }
  ...
  sm(mn) {
    ...
    if (!Utils.checkNumber(mn)) {
      alert("MgrDrawED::sm()::Error: mn is not a number!!!: mn = " + mn + "!!!");
      return;
    }

    if ( (mn != 1) && (mn != 2) ) {
      alert("MgrDrawED::sm()::Error: mn is strange!!!: mn = " + mn + "!!!");
      return;
    }
  ...
  coefPixToCM(coef) {
    ...
    if (!Utils.checkNumber(coef)) {
      alert("MgrDrawED::coefPixToCM()::Error: coef is not a number!!!: coef = " + coef + "!!!");
      return;
    }

    if ( (coef <= 0) || (coef > 300) ) {  //MMM 30
      alert("MgrDrawED::coefPixToCM()::Error: coef is strange!!!: coef = " + coef + "!!!");
      return;
    }
  ...
  scalesOfAxes(scales) {
    ...
    if (typeof(scales) !== "object") {
      alert("MgrDrawED::scalesOfAxes()::Error: scales is not an object!!!: typeof(scales) = " + typeof(scales) + "!!!");
      return;
    }
  ...
  scalesOfCanvEmb(scales) {
    ...
    if (typeof(scales) !== "object") {
      alert("MgrDrawED::scalesOfCanvEmb()::Error: scales is not an object!!!: typeof(scales) = " + typeof(scales) + "!!!");
      return;
    }
  ...
  currViewBounds(currbounds) {
    ...
    if (typeof(currbounds) !== "object") {
      alert("MgrDrawED::currViewBounds()::Error: currbounds is not an object!!!: currbounds = " + currbounds + "!!!");
      return;
    }
  ...
  currEventBounds(currbounds) {
    ...
    if (typeof(currbounds) !== "object") {
      alert("MgrDrawED::currEventBounds()::Error: currbounds is not an object!!!: currbounds = " + currbounds + "!!!");
      return;
    }
  ...
  groupXYAxesIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupXYAxesIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupZAxesIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupZAxesIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupTTWallsIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupTTWallsIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupBrickWallsIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupBrickWallsIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupRPCLayersIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupRPCLayersIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupDTLayersIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupDTLayersIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupVisBricksIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupVisBricksIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupVertBrickIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupVertBrickIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupTTHitsIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupTTHitsIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupRPCHitsIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupRPCHitsIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupDTHitsIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupDTHitsIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupNeuVertexIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupNeuVertexIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupPartTracksIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupPartTracksIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  groupMuTrackIDs(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::groupMuTrackIDs()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  axesTitles(ip) {
    ...
    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::axesTitles()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  axesTitles2(ip) {
    ...
    if (ip === undefined) return this._axesTitles2;

    if (!Utils.checkIP(ip)) {
      alert("MgrDrawED::axesTitles2()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }

    return this._axesTitles2[ip];
  ...
  hitTTdims(ip) {
    ...
    if (!Utils.checkIP(ip, 3)) {
      alert("MgrDrawED::hitTTdims()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
  ...
  hitRPCdims(ip) {
    ...
    if (!Utils.checkIP(ip, 3)) {
      alert("MgrDrawED::hitRPCdims()::Error: ip is wrong!!!: ip = " + ip + "!!!");
      return;
    }
